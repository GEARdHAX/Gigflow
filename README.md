...
| Platform | URL | Status |
|----------|-----|--------|
| **🌐 Frontend** | [vercel](https://gigflow.vercel.app) | ![Live](https://img.shields.io/badge/Live-Online-brightgreen) |
| **🔧 Backend API** | [koyeb](https://powerful-natalie-adarsharya2911-a06d181d.koyeb.app/api) | ![API](https://img.shields.io/badge/API-Running-blue) |
